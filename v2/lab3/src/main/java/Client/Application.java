...
public class Application extends JFrame {
    ...
    private Application() {
        ...
        comboAuthor.addActionListener(e -> {
            ...
            currentAuthor = client.authorFindByName( (String) comboAuthor.getSelectedItem());
            authorMode = true;
            authorPanel.setVisible(true);
            bookPanel.setVisible(false);
            fillAuthorFields();
        ...
        comboBook.addActionListener(e -> {
            ...
            currentBook =client.bookFindByName((String) comboBook.getSelectedItem());
            authorMode = false;
            authorPanel.setVisible(false);
            bookPanel.setVisible(true);
            fillBookFields();
    ...
    private static void delete() {
        if (editMode) {
            if (authorMode) {
                var list = client.bookFindByAuthorId(currentAuthor.getId());
                assert list != null;
    ...
    private void fillComboBoxes() {
        ...
        var authors = client.authorAll();
        var books = client.bookAll();
